...
class _CoronaState extends State<Corona> {
  ...
  fetchWorldWideData()async{
    http.Response response= await http.get('https://newsapi.org/v2/everything?' + 'q=COVID&' + 'sortBy=popularity&' + 'apiKey=4eac28bee74a481fb1273bf5b7a5a83a');
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text('COVID-19 News', style: TextStyle(color: Color(0xFF99aab5)),),
