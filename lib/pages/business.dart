...
class _BusinessState extends State<Business> {
  ...
  fetchWorldWideData()async{
    http.Response response= await http.get('https://newsapi.org/v2/everything?' + 'q=business&' + 'sortBy=popularity&' + 'apiKey=4eac28bee74a481fb1273bf5b7a5a83a');
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text('Business News', style: TextStyle(color: Color(0xFF99aab5)),),
