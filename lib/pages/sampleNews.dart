...
class _TrendingNewsState extends State<TrendingNews> {
  ...
  fetchWorldWideData()async{
    http.Response response= await http.get('http://newsapi.org/v2/top-headlines?' + 'country=in&' + 'apiKey=4eac28bee74a481fb1273bf5b7a5a83a');
...
fetchWorldWideData();
  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      appBar: AppBar(title: Text('Trending News', style: TextStyle(color: Color(0xFF99aab5)),),
